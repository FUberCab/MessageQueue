...
//    if(!clients[self.type]) console.log( "******************** creating BLPOP client... " );
    ...
    client.blpop(client.getKey(self.type + ':jobs'), 0, function (err) {
        if (err || !self.running) {
            ...
            client.ltrim(client.getKey(self.type + ':jobs'), 0, 0); //JLE added to prevent crazy growth
...
Worker.prototype.shutdown = function (fn, timeout) {
    ...
    var _fn = function (job) {
        ...
        self.client.ltrim(self.client.getKey(self.type + ':jobs'), 0, 0); //JLE added to prevent crazy growth
